							...
							<c:forEach var="address" items="${user.addresses}" varStatus="sta">
								...
								<div  class="panel panel-primary selectPanel">
									...
									<div class="panel-body">
										...
										<div class="row ">
											<div class="col-md-12 col-xs-12">收货地址:&nbsp&nbsp<span class="province">${address.province}</span><span class="city">${address.city}</span><span class="county">${address.county}</span><span class="address">${address.address}</span></div>
										</div>
									</div>
								</div>
