				...
				<div class="container-fluid">
					...
					<div class="col-md-12 col-xs-12">
						<form class="navbar-form form-horizontal navbar-left" id="searchForm"
							role="search" action="<c:url value='/purchase/record.html'/>"
							method="GET">
					...
					<!-- 	<ul class="nav navbar-nav navbar-right">
							<li><button type="button"
									...
									<li class="fa fa-exchange fa-fw"></li>转让进货券
								</button></li>
						</ul> -->
						</div>
					</div>
	...
	<script type="text/javascript">
		$(function() {
            $("#download").click(function(){
                $("#searchForm").attr("action", "<c:url value='/purchase/downRecord.html'/>")
                $("#searchForm").submit();
            });
			...
			$(".transBtn").click(
					function(e) {
						...
						e.stopPropagation();
						$("#myModal").load(
								"<c:url value='/purchase/transfer.html'/>",
								function(e) {
									$('#myModal').modal({
										backdrop : "static"
									});
