							...
							<div class="panel-body">
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<p class="form-control-static">${parameter.entity.addressClone.consignee}</p>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<p class="form-control-static">${parameter.entity.addressClone.mobile}</p>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<p class="form-control-static">${parameter.entity.addressClone.province}${parameter.entity.addressClone.city}${parameter.entity.addressClone.county}${parameter.entity.addressClone.address}</p>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									<div class="form-group">
								...
								<div class="col-md-12">
									<div class="table-responsive">
										<table
											...
											<tbody id="itemsBody">
												<c:forEach items="${parameter.entity.items}" var="item" varStatus="vs">
													<tr data-id="${item.pmallGoods.id}">
														<td>${item.pmallGoods.name}
														</td>
														<td>
															${sn[vs.index]}
														</td>
