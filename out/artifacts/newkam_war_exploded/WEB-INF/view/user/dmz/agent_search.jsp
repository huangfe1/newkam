...
<nav class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<c:url value='/login.html'/>"><img alt="Brand" style="width:20px;height:20px;" src="<c:url value='/resources/images/title-1.png'/>"></a>
...
<div class="container-fluid">
    ...
    <c:if test="${agent!=null}">
        <div align="center">
            <c:if test="${agent.agentStatus.desc ne '整顿'}">
                <img style="" class="letter"
                     src="<c:url value='/auth/dmz/letterimg/${agent.agentCode}.html'><c:param name='id' value='${auth.id}'/></c:url>">
            </c:if>
        </div>
        <%--<div class="row">--%>
        <%--<div class="col-md-12   col-sm-12 col-xs-12">--%>
