                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-form navbar-left">
                        <div class="form-group">
                            ...
                            <%--<input required type="text" value="咖盟雪莲护理贴小礼盒" name="goodsName" id="goodsName"--%>
                            <%--autofocus class="typeahead form-control"--%>
                            <%--placeholder="产品名称">--%>
                            <select class="form-control" name="goodsName" id="goodsName">
                                <option value="咖盟雪莲护理贴小礼盒">洗眼液</option>
                            </select>
        ...
        $(".scanBtn").click(function () {
            ...
            wx.scanQRCode({
                ...
                success: function (res) {
                    ...
                    if(code.indexOf("biofreda")>=0||code.indexOf("zmz365")>=0){
