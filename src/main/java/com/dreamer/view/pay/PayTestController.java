	...
	public String testPay(
		...
		try {
			...
			UriComponents ucb = ServletUriComponentsBuilder.fromHttpUrl(
					GET_OPENID_URL).buildAndExpand(null,
					null, code);
...
//			param.setTotal_fee((new Double(order.getActualPayment()*100)).intValue());
			...
			param.setSign(Signature.getSign(param, null));
			...
			jsapiParam.put("paySign", Signature.getSign(jsapiParam, null));
