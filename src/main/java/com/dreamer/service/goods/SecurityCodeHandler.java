...
import com.dreamer.domain.mall.securityCode.SecurityCodeSegment;
import com.dreamer.domain.mall.securityCode.SecurityCodeSegmentWithNum;
...
public class SecurityCodeHandler {
	...
	public void addCodeSegment(User user,SecurityCode securityCode,String codeSegment){
		...
		segmentCodes.forEach(s->{
			...
			if(null!=securityCode.getUpdateTime())
				code.setUpdateTime(securityCode.getUpdateTime());
			code.setCode(s);
