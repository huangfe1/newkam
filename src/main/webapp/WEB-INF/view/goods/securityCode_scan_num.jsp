                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-form navbar-left">
                        <div class="form-group">
                            ...
                            <%--<input required type="text" value="和之初雪莲护理贴小礼盒" name="goodsName" id="goodsName"--%>
                                                                <%--autofocus class="typeahead form-control"--%>
                                                                <%--placeholder="产品名称">--%>
                            <select class="form-control" name="goodsName" id="goodsName">
                            <option value="和之初雪莲护理贴小礼盒">和之初雪莲护理贴小礼盒</option>
                            <option value="和之初生态复元贴">和之初生态复元贴</option>
                            </select>
