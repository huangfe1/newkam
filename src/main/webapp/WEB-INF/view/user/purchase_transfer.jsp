...
<div class="modal-dialog modal-lg" role="document">
	<form action="<c:url value='/purchase/transfer.json'/>"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary" id="myModalLabel">代理进货券转账</h4>
			</div>
					...
					<div class="row">
						<div class="col-md-12 col-xs-12">
							...
							<div class="panel panel-primary">
								<div class="panel-heading">转出方进货券账户基本信息</div>
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">当前进货券余额</label>
										<div class="col-sm-6">
											<p class="form-control-static">${purchaseBalance}</p>
										</div>
									</div>
								</div>
							</div>
							<div class="panel panel-danger">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label for="purchase" class="col-sm-2 control-label">转出进货券数量</label>
										<div class="col-sm-4">
											<input type="number" class="form-control" required
												id="purchase" tabIndex="12" name="purchase" value=""
												<c:if test="${purchaseBalance<=0}">
										disabled="disabled"
										</c:if>
												placeholder="输入转出数量">
												<c:if test="${purchaseBalance<=0}">
													<span class="help-block text-danger">进货券余额为0时无法转出</span>
												</c:if>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-12">
							<button type="submit" class="btn btn-success btn-block"
								...
								<span class="glyphicon glyphicon-save">&nbsp;</span>转让进货券
							</button>
						</div>
					</div>
				</div>
