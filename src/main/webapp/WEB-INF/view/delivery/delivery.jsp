						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">收货人代理编号</label>
										<div class="col-sm-4">
											<p class="form-control-static">${parameter.entity.address.consigneeCode}</p>
										</div>
										<label  class="col-sm-2 control-label">收货人姓名</label>
										<div class="col-sm-4">
											<p class="form-control-static">${parameter.entity.address.consignee}</p>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<p class="form-control-static">${parameter.entity.address.mobile}</p>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									<div class="form-group">
