...
<script>
    $(function () {
        ...
        //发送消息封装
        function sendMessage(fromId, toId, avatar, msg) {
            var message = {
                "fromId": fromId,
                "toId": toId,
                "avatar": avatar,
        ...
        $(".send").click(function () {
            ...
            $("input").val("");
            $("input").keyup();
            var msg = sendMessage(mid, oid, avatar, content);//socket发送
            showMessage(msg);
//            $("#mt").tmpl(msg).appendTo($(".message"));//实时显示
            saveMessage(msg, oid);//存储数据
...
//            }, 1000);
        ...
        //存储数据
        var saveMessage = function (msg, key) {
